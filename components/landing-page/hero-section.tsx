...
const LiveBadge = () => {
    return (
        <Badge variant='outline' className='px-4 py-6 mb-8 text-sm lg:text-lg'>
            <span className='relative flex h-2 w-2 mr-2'>
                <span className='animate-ping absolute inline-flex h-full w-full rounded-full bg-pink-500 opacity-90'></span>
        ...
        <section className='relative overflow-hidden bg-linear-to-b from-background via-background to-muted/20'>
            <div className='wrapper'>
                <div className='flex flex-col items-center justify-center lg:py-24 py-12 text-center'>
                    <LiveBadge />
                    <h1 className='text-5xl sm:text-6xl lg:text-8xl tracking-tight mb-6  font-bold'>
                        Share What You've Built, Discover What's Launching
                    </h1>
                    <p className='text-muted-foreground text-lg sm:text-xl lg:text-2xl mb-10  leading-relaxed'>
                    ...
                    <div className='grid grid-cols-1 mt-8 sm:grid-cols-3 gap-8 sm:gap-12 max-w-2xl w-full'>
                    {
                        statData.map((stat) => (
